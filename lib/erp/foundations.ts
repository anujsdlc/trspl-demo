...
export const ERP_MODULES: ERPModule[] = [
  ...
  { key: 'purchase',      label: 'Purchase',            href: '/admin/erp/purchase',            icon: 'ShoppingCart',    status: 'coming-soon', phase: 2, section: 'Buy → Sell' },
  { key: 'sales',         label: 'Sales & Invoicing',   href: '/admin/erp/sales',               icon: 'Receipt',         status: 'coming-soon', phase: 2, section: 'Buy → Sell' },
  { key: 'customers',     label: 'Customers',           href: '/admin/erp/sales/customers',     icon: 'Users',           status: 'coming-soon', phase: 2, section: 'Buy → Sell' },
  { key: 'suppliers',     label: 'Suppliers',           href: '/admin/erp/purchase/suppliers',  icon: 'Truck',           status: 'coming-soon', phase: 2, section: 'Buy → Sell' },
