...
const relayConvenience: Product[] = [
  ...
  { id: 'rly-tc-005', sku: 'RLY-HP-EP', title: 'HP Wired Earphones', subtitle: 'In-ear · 3.5mm', brand: 'RLY', category: 'tech', image: 'https://images.unsplash.com/photo-1533379007656-3a10925da2e2?w=800&h=1000&fit=crop&crop=entropy&q=90&auto=format', price: 349, tags: ['tech', 'audio', 'wired'] },
  ...
  { id: 'rly-tr-002', sku: 'RLY-TR-EMK', title: 'Eye Mask + Earplugs Kit', subtitle: 'Sleep essentials on-board', brand: 'RLY', category: 'travel', image: 'https://images.unsplash.com/photo-1666934209818-cd6a6d08bd8d?w=800&h=1000&fit=crop&crop=entropy&q=90&auto=format', price: 199, tags: ['travel', 'sleep'], bogo: true },
  { id: 'rly-tr-003', sku: 'RLY-TR-DL', title: 'Digital Luggage Scale', subtitle: 'Weigh up to 50kg', brand: 'RLY', category: 'travel', image: 'https://images.unsplash.com/photo-1593215129811-434e20186220?w=800&h=1000&fit=crop&crop=entropy&q=90&auto=format', price: 899, tags: ['travel', 'gadget'] },
  { id: 'rly-tr-004', sku: 'RLY-TR-TSA', title: 'TSA-Approved Lock', subtitle: 'Combination · steel body', brand: 'RLY', category: 'travel', image: 'https://images.unsplash.com/photo-1587195399841-fc7174360a86?w=800&h=1000&fit=crop&crop=entropy&q=90&auto=format', price: 349, tags: ['travel', 'security'] },
  { id: 'rly-tr-005', sku: 'RLY-TR-PW', title: 'Passport & RFID Wallet', subtitle: 'Vegan leather · card slots', brand: 'RLY', category: 'travel', image: 'https://images.unsplash.com/photo-1637262448017-0fbbec87a898?w=800&h=1000&fit=crop&crop=entropy&q=90&auto=format', price: 799, compare: 999, tags: ['travel', 'security'] },
...
const cashmere: Product[] = [
  ...
  { id: 'ps-002', sku: 'PS-SCF-IV', title: 'Ivory Ring Stole', subtitle: 'Featherweight · 200g', brand: 'PSH', category: 'cashmere', image: 'https://images.unsplash.com/photo-1551381912-4e2e29c7fd17?w=800&h=1000&fit=crop&crop=entropy&q=90&auto=format', price: 8999, tags: ['luxury', 'stole'] },
  { id: 'ps-003', sku: 'PS-SWT-RS', title: 'Cashmere Turtleneck', subtitle: 'Merlot · Fine gauge', brand: 'PSH', category: 'cashmere', image: 'https://images.unsplash.com/photo-1603906650843-b58e94d9df4d?w=800&h=1000&fit=crop&crop=entropy&q=90&auto=format', price: 19999, tags: ['luxury', 'sweater'], featured: true },
  { id: 'ps-004', sku: 'PS-SCF-BL', title: 'Cobalt Silk-Cashmere Wrap', subtitle: 'Hand-loomed · 80/20 blend', brand: 'PSH', category: 'cashmere', image: 'https://images.unsplash.com/photo-1567636372197-ddf1604d2766?w=800&h=1000&fit=crop&crop=entropy&q=90&auto=format', price: 11999, tags: ['luxury', 'wrap'] },
];
